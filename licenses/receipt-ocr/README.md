...
- Android: Tesseract4Android 4.9.0, Apache-2.0, https://github.com/adaptech-cz/Tesseract4Android/tree/4.9.0 . AAR checksum is pinned in `scripts/build-android.py`.
